		...
		<h2 class="title text-center">Product <strong>List</strong></h2>
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								com.YaoZhibin.model.Product p= (com.YaoZhibin.model.Product) pageContext.findAttribute("p");
								int pid=p.getCategoryID();
								java.sql.Connection con= (Connection) application.getAttribute("con");
								String catName=com.YaoZhibin.model.Category.findByCategoryId(pid,con);
							%>
